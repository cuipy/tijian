...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/wshbj/specimen/">检查标本类型列表</a></li>
		<shiro:hasPermission name="wshbj:specimen:edit"><li><a href="${ctx}/wshbj/specimen/form">检查标本类型添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="specimen" action="${ctx}/wshbj/specimen/" method="post" class="breadcrumb form-search">
