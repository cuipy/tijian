...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/wshbj/examinationItemType/">检查项目类型列表</a></li>
		<shiro:hasPermission name="wshbj:examinationItemType:edit"><li><a href="${ctx}/wshbj/examinationItemType/form">检查项目类型添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="examinationItemType" action="${ctx}/wshbj/examinationItemType/" method="post" class="breadcrumb form-search">
