...
<body>
	...
	<ul class="nav nav-tabs">
		...
		<li ><a href="${ctx}/wshbj/examinationRecord/tongji2">体检人员月综合统计</a></li>
 		<li class="active"><a href="${ctx}/wshbj/examinationRecord/tongji4">不合格人员统计</a></li>


	</ul>
	<div class="box1">

		<form:form id="searchForm"  action="${ctx}/wshbj/examinationRecord/tongji4" method="post" class="breadcrumb form-search">
