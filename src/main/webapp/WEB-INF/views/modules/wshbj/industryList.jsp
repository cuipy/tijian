...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/wshbj/industry/">行业管理列表</a></li>
		<shiro:hasPermission name="wshbj:industry:edit"><li><a href="${ctx}/wshbj/industry/form">行业管理添加</a></li></shiro:hasPermission>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="industry">
			<tr>
				...
				<td>
					<fmt:formatDate value="${industry.updateDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
