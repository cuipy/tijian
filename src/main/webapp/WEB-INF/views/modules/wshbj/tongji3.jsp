...
<body>
	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/wshbj/examinationRecord/tongji3">健康检查年统计</a></li>
	...
	<div class="box1">
		...
		<form:form id="searchForm"  action="${ctx}/wshbj/examinationRecord/tongji3" method="post" class="breadcrumb form-search">
