...
public interface ExaminationRecordItemDao extends CrudDao<ExaminationRecordItem> {
     ...
     * @return java.util.List<com.thinkgem.jeesite.modules.wshbj.entity.ExaminationRecordItem>
     */
    List<ExaminationRecordItem> listByRecordIdAndDetId(@Param("recordId")String recordId,@Param("recordResultDeptId")String recordResultDeptId);
    /**
     * @author zhxl
    ...
    Integer updateGrabSample(@Param("examRecordId")String examRecordId, @Param("specimenId")String specimenId,@Param("strtodate")Date strtodate);
