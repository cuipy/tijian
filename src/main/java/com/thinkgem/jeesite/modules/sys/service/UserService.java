...
public class UserService extends CrudService<UserDao, User> {
	...
	public String getPhotoImg(String id) {
		return dao.getPhotoImg(id);
	}
	public String getQianmingImg(String id) {
		return dao.getQianmingImg(id);
	}
