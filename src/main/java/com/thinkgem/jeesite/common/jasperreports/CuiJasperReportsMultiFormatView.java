 ...
 */
public class CuiJasperReportsMultiFormatView extends CuiAbstractJasperReportsView {
	 ...
	 */
	private Map<String, Class<? extends CuiAbstractJasperReportsView>> formatMappings;
   ...
   */
	public CuiJasperReportsMultiFormatView() {
		this.formatMappings = new HashMap<String, Class<? extends CuiAbstractJasperReportsView>>(4);
	...
	protected void renderReport(JasperPrint populatedReport, Map<String, Object> model, HttpServletResponse response)
		...
		Class<? extends CuiAbstractJasperReportsView> viewClass = this.formatMappings.get(format);
		if (viewClass == null) {
		...
		CuiAbstractJasperReportsView view = BeanUtils.instantiateClass(viewClass);
